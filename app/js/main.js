...
var APP_ID = '88arqa0AV2h7KjKrheweb8wosV4JBFgzetjgcCLg';
var API_KEY = '1ZSbvmwoUxkUIE64EkWimNDp3SDW9hJDG0tvoW4n';
...
var _individualDetailModel = require('./individualDetailModel');

var _individualDetailModel2 = _interopRequireDefault(_individualDetailModel);

var allDetailsCollection = _backbone2['default'].Collection.extend({

  url: 'https://api.parse.com/1/classes/MyPeeps',

  model: _individualDetailModel2['default'],
...
exports['default'] = allDetailsCollection;
module.exports = exports['default'];

},{"./individualDetailModel":3,"backbone":11}],3:[function(require,module,exports){
'use strict';
...
var individualDetailModel = _Backbone2['default'].Model.extend({
...
exports['default'] = individualDetailModel;
module.exports = exports['default'];
...
},{"./ajaxSetup":1,"./router":5,"jquery":12}],5:[function(require,module,exports){
'use strict';
...
var _viewsIndividualDetail = require('./views/individualDetail');

var _viewsIndividualDetail2 = _interopRequireDefault(_viewsIndividualDetail);

var _viewsContactListTemplate = require('./views/contactListTemplate');

var _viewsContactListTemplate2 = _interopRequireDefault(_viewsContactListTemplate);

var _allDetailsCollection = require('./allDetailsCollection');

var _allDetailsCollection2 = _interopRequireDefault(_allDetailsCollection);
...
var _viewsNewContactTemplate = require('./views/newContactTemplate');

var _viewsNewContactTemplate2 = _interopRequireDefault(_viewsNewContactTemplate);
...
var Router = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el = appElement;
    this.details = new _allDetailsCollection2['default']();
  ...
  showIndividualDetail: function showIndividualDetail(detailId) {
    var _this = this;
    ...
    if (detail) {
      ...
      (function () {
        ...
        detail.fetch().then(function () {
          router.$el.html((0, _viewsIndividualDetail2['default'])(detail.toJSON()));
        });
      })();
    }
  },
...
},{"./allDetailsCollection":2,"./views/contactListTemplate":6,"./views/home":7,"./views/individualDetail":8,"./views/newContactTemplate":9,"backbone":11,"jquery":12}],6:[function(require,module,exports){
'use strict';
